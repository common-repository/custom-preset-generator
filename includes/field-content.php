...
function cpg_getBlogLayoutFields()
{
	return array(
...
function cpg_getPostLayoutFields()
{
	return array(
...
function cpg_getArchiveLayoutFields()
{
	return array(
...
function cpg_getLightboxFields()
{
	return array(
		'fl_lightbox' => array(
			'type' => 'select',
